    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price_per_service', models.BigIntegerField(default=0, verbose_name='قیمت هر سرویس')),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='industries', to='Industries.industrycategory', verbose_name='دسته\u200cبندی')),
            ],
            options={
                'verbose_name': 'صنعت',
